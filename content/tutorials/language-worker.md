...
Other programs available in Wasta-Linux
...
![USB Memory Stick](/media/tutorials/language-worker/UsbMemStick600.jpg)
...
![Wasta-Backup 1](/media/tutorials/language-worker/WastaBackup1Circle.png)
...
![Wasta-Backup 2](/media/tutorials/language-worker/WastaBackup2Circle.png)
...
![Wasta-Backup 3](/media/tutorials/language-worker/WastaBackup3Arrow.png)
...
![File Manager in Panel](/media/tutorials/language-worker/FilesLauncherInPanel.gif)
...
![File Manager](/media/tutorials/language-worker/FileManagerMainWindow.gif)
...
### The Home Folder
  ...
  ![Home Folder](/media/tutorials/language-worker/HomeFolder.gif)
...
![Home Folder](/media/tutorials/language-worker/DefaultFolders.gif)
...
![Adapt It Folder](/media/tutorials/language-worker/AdaptItUnicodeWorkFolder.gif)
...
![Paratext Folder](/media/tutorials/language-worker/ParatextProjectsFolder.gif)
...
![List Folder Contents](/media/tutorials/language-worker/FolderOpenListArrow.gif)
...
![Child Folders](/media/tutorials/language-worker/ChildFoldersEmbeddedWithPictureFile.gif)
...
![List Folder Contents](/media/tutorials/language-worker/FolderPathAndNavButtons.gif)
...
------------------|---------------------------
![Previous Folder](/media/tutorials/language-worker/BackToPrevVisitedLocationArrow.gif) | Go to the previous visited location
![Next Folder](/media/tutorials/language-worker/GoToNextVisitedLocationArrow.gif) | Go to the next visited location (grayed out if there is no next location recently visited)
![Parent Folder](/media/tutorials/language-worker/GoToParentFolderArrow.gif) | Go to parent folder
![Reload](/media/tutorials/language-worker/ReloadTheCurrentLocationButton.gif) | Reload the current location
![Home Folder](/media/tutorials/language-worker/GoToHomeDirectory.gif) | Go to Home Directory
![Computer](/media/tutorials/language-worker/GoToComputer.gif) | Go to Computer
![Show Left Path](/media/tutorials/language-worker/ShowMoreOfThePathToTheLeft.gif) | Show more of the path to the left (when window is too small to show entire path)
![Show Path Right](/media/tutorials/language-worker/ShowMoreOfThePathToTheRight.gif) | Show more of the path to the right (when window is too small to show entire path)
...
![List View Headings](/media/tutorials/language-worker/NameSizeTypeDateModifiedBar.gif)
...
![Status Bar](/media/tutorials/language-worker/StatusBarFileBrowser.gif)
...
![Nemo About Dialog](/media/tutorials/language-worker/FileBrowserHelpAboutDialog.gif)
